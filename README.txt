...
Future tasks:
* Move configuration of m_participants out into an external file (get rid of need for hard coded assignment)
* Move mail settings out into external configuration file
* Move Subject/Body out into external configuration file
